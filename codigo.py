...
# Função que verifica se a pagina já esta na memoria, se não estiver ele incrementa do numero de faltas de paginas e substitui pela mais antiga
...
# Função que verifica se a pagina já esta na memoria, se não estiver ele incrementa do numero de faltas de paginas e substitui pela mais antiga q n foi usada recentemente
...
# Resultados da FIFO
    ...
    for num_frames in num_frames_list:
        avg_faults = simulate_paging_algorithm(fifo, page_references, [num_frames] * num_simulations)
        print(f"Faltas de paginas (Frames={num_frames}): {avg_faults:.2f}")

# Resultados do Aging
    print("\nSimulando o Aging:")
    for num_frames in num_frames_list:
        avg_faults = simulate_paging_algorithm(aging, page_references, [num_frames] * num_simulations)
        print(f"Faltas de paginas (Frames={num_frames}): {avg_faults:.2f}")
